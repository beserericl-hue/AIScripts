...
| [[cr-040-appendix-papers-as-supporting-evidence-files]] | Detect appendix research papers / student work samples, capture their images, package each as a .docx, store in S3, surface as compact "View file" cards in the wizard | proposed | User observation 2026-05-23 (Stevenson "Sample Country Report" + "Immigrant Interview Paper" landing as flat narrative cards with images lost) |
