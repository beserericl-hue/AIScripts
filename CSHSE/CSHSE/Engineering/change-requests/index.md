...
| [[cr-042-memberclick-sso-api-entry-point]] | API-key SSO entry point — MemberClick calls a CSHSE API with email + key, user lands authenticated; same key is the password-less auth path for E2E tests (kills plaintext passwords in CR-034 fixtures) | proposed | User direction 2026-05-23 (MemberClick integration + E2E password elimination) |
