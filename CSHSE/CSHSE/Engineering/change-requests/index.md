...
| [[cr-038-railway-path-based-deploy-filter]] | ~~Config-only: each Railway service watches only its own subdir so docs/e2e pushes don't bounce ai-service~~ | **retired** 2026-05-23 — dev environment only affects developers; production deploys are PR-cadence; CR-036 handles runtime resilience |
